...
- **bar**: A react component, that gets compiled by Next.js (see [packages/www/next.config.js](./packages/www/next.config.js) for more info)
...
> Choose `packages/www` as root directory when deploying.
