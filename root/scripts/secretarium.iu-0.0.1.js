...
body.sec-modal-show .sec-modal-wrap {
        ...
        <div>
            ...
            <div class="sec-modal-content">
                ...
                <div style="margin-top: 1.5rem">
                    ...
                    <button type="button" class="sec-modal-btn sec-modal-btn-primary" style="min-width: 6rem; margin-left: 1rem" @click="onOk">OK</button>
